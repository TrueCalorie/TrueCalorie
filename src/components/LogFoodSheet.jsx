    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {mode ? (
            <button onClick={reset} style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'var(--muted)', fontSize: 20, padding: '0 12px 0 0', lineHeight: 1 }}>
              ←
            </button>
          ) : <div style={{ width: 32 }} />}
          ...
          <button onClick={handleClose} style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'var(--muted)', fontSize: 20, padding: '0 0 0 12px', lineHeight: 1 }}>
            ×
          </button>
        </div>
                    ...
                    {savedFoods.map((food, i) => (
                      ...
                      >
                        <div style={{ flex: 1, minWidth: 0, marginRight: 12 }}>
                          ...
                          {food.brand_name && (
                            <div style={{ fontSize: 12, color: 'var(--muted)', marginTop: 2 }}>{food.brand_name}</div>
                          )}
                        </div>
                ...
                <div style={{ marginBottom: 20 }}>
                        ...
                        <div style={{ flex: 1, minWidth: 0, marginRight: 12 }}>
                          ...
                          {(item.brand_name || item.verified) && (
                            <div style={{ fontSize: 12, color: 'var(--muted)', display: 'flex', alignItems: 'center', gap: 8, marginTop: 2 }}>
                              ...
                              {item.verified && (
                                <span style={{ fontSize: 9, color: '#1D9E75', fontWeight: 700, letterSpacing: '0.08em' }}>VERIFIED</span>
                              )}
                            </div>
                          )}
                        </div>
                  ...
                  {totalPages > 1 && (
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12, marginTop: 10 }}>
                      ...
                      >←</button>
                      <span style={{ fontSize: 13, color: 'var(--muted)' }}>{resultPage + 1} of {totalPages}</span>
                      <button
