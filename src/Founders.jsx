...
// Stripe Payment Link — $80/year recurring founders price
// To set up: Stripe Dashboard → Products → Add product → $80/year recurring
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 600, margin: '0 auto', padding: '64px 32px 80px' }}>
        ...
        <p className="fade-up" style={{
          ...
          TrueCalorie Pro is $9.99 a month. Founders get it for $80 a year,
        ...
        <div className="fade-up" style={{ marginBottom: 36 }}>
          ...
          {[
            ...
            { icon: '🔒', text: '$80/year locked in. Forever. No matter what Pro costs later.' },
          ].map((item, i) => (
            <div key={i} style={{
        ...
        <div className="fade-up" style={{
          ...
          TrueCalorie Pro is $9.99/month. Founders pay $80/year, and that rate
